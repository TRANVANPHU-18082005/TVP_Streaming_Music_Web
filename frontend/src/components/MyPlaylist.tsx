...
import { AlertCircle, ListMusic, ChevronRight, Turntable } from "lucide-react";
  ...
  <div className="flex items-start justify-between gap-4 mb-7 sm:mb-8">
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        <div
          ...
          style={{
            background: "hsl(var(--wave-6) / 0.12)",
            color: "hsl(var(--wave-6))",
          }}
        >
    ...
    <Link
      ...
      className={cn(
        ...
        "text-sm font-medium text-wave-6 opacity-70",
        "hover:text-wave-6 transition-colors duration-200 hover:opacity-100",
      )}
