...
import { useMyFollowedArtists } from "@/features/artist/hooks/useArtistsQuery";
...
// ─────────────────────────────────────────────────────────────────────────────
const MyFollowerArtistHeader = memo(
    ...
    <div className="flex items-start justify-between gap-4 mb-7 sm:mb-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-section-subtitle hidden sm:block">
          Những nghệ sĩ mà bạn đang theo dõi.
        </p>
      </div>
...
MyFollowerArtistHeader.displayName = "MyFollowerArtistHeader";
...
const ArtistScroll = memo(({ artists }: { artists: IArtist[] }) => (
  <div
    ...
    role="list"
    aria-label="Danh sách nghệ sĩ đã theo dõi"
  >
    <HorizontalScroll>
...
// ─────────────────────────────────────────────────────────────────────────────
export function MyFollowerArtists() {
  const { data, isLoading, isError, refetch } = useMyFollowedArtists({
    limit: 7,
  });
    ...
    <>
      ...
      >
        ...
        <div className="section-container">
          <MyFollowerArtistHeader viewAllHref="/artists" />
...
export default MyFollowerArtists;
